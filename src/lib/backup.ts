...
const AssetSchema = z.object({
  ...
  symbol: z.string(),
  name: z.string(),
  type: z.enum(["crypto", "stock_us", "stock_idx", "stock", "gold_physical", "gold_digital", "mutual_fund", "deposito", "foreign_currency"]),
  quantity: z.number(),
  avgBuyPrice: z.number(),
  coinGeckoId: z.string().optional(),
  manualPriceIdr: z.number().optional(),
  interestRatePerYear: z.number().optional(),
  depositStartDate: z.string().optional(),
  depositEndDate: z.string().optional(),
  createdAt: z.string(),
  updatedAt: z.string(),
});
